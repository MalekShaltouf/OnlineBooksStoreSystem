<%@ Page Title="Add Category" Language="C#" MasterPageFile="~/Layout2.Master" AutoEventWireup="true" CodeBehind="AddCategory.aspx.cs" Inherits="OnlineBooksStoreSystem.WebForm12" %>
            ...
            <div class="wrap-login100 p-t-85 p-b-20">
                <form runat="server" class="login100-form validate-form">
                    ...
                    <div class="container-login100-form-btn">
                        <asp:Button CssClass="login100-form-btn" Font-Bold="true" Font-Names="Arial" runat="server" Text="Add Category" OnClick="AddCategory_Click" />
                    </div><br />
                    <div class="Labels">
