<%@ Page Title="Add User" Language="C#" MasterPageFile="~/Layout2.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="OnlineBooksStoreSystem.Pages.Admin.Users.AddUser" %>
            ...
            <div class="wrap-login100 p-t-85 p-b-20">
                <form runat="server" class="login100-form validate-form">
                   ...
                   <div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate="Enter BirthDate">
                    ...
                    <div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate="Enter UserType">
                        <asp:DropDownList CssClass="input100 dd" ID="UserTypeDDList" runat="server"></asp:DropDownList>
                    </div>
                    <div class="container-login100-form-btn">
                        <asp:Button CssClass="login100-form-btn" Font-Bold="true" Font-Names="Arial" runat="server" Text="Add User" OnClick="AddUser_Click"/>
                    </div><br />
                    <div class="Labels">
