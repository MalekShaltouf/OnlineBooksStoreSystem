<%@ Page Title="Add Book" Language="C#" MasterPageFile="~/Layout2.Master" AutoEventWireup="true" CodeFile="AddBook.aspx.cs" Inherits="OnlineBooksStoreSystem.WebForm13" %>
            ...
            <div class="wrap-login100 p-t-85 p-b-20">
                <form runat="server" class="login100-form validate-form">
                    ...
                    <div class="container-login100-form-btn">
                        <asp:Button CssClass="login100-form-btn" Font-Bold="true" Font-Names="Arial" runat="server" Text="Add Book" OnClick="AddBook_Click" />
                    </div><br />
                    <div class="Labels">
